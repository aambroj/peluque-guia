...
const features = [
  {
    title: "Reservas más ordenadas",
    description:
      "Gestiona citas, cambios, estados y disponibilidad desde un panel claro y rápido de usar.",
  },
  {
    title: "Clientes y equipo en un solo sitio",
    description:
      "Centraliza clientes, empleados, horarios, bloqueos y vacaciones sin depender de notas o mensajes sueltos.",
  },
  {
    title: "Servicios y precios controlados",
    description:
      "Configura duración, precio y estado de cada servicio para mantener tu negocio siempre actualizado.",
  },
  {
    title: "Reserva online para tus clientes",
    description:
      "Comparte tu enlace público y deja que tus clientes reserven de forma cómoda, directa y profesional.",
  },
  {
    title: "Panel pensado para el día a día",
    description:
      "Consulta la actividad del salón, ingresos y operativa diaria desde un dashboard fácil de entender.",
  },
  {
    title: "Base moderna para crecer",
    description:
      "Estructura SaaS y multi-negocio preparada para evolucionar con una imagen más sólida y vendible.",
  },
];
...
const steps = [
  ...
  {
    title: "Configura tu equipo y servicios",
    description:
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:px-8 lg:py-24">
          <div className="relative">
            ...
            <h1 className="mt-6 max-w-4xl text-4xl font-bold leading-tight tracking-tight text-zinc-900 sm:text-5xl lg:text-6xl">
              Organiza tu salón con una herramienta clara, moderna y lista para
              trabajar de verdad.
            </h1>

            <p className="mt-6 max-w-2xl text-base leading-8 text-zinc-600 sm:text-lg">
              Peluque-Guía te ayuda a gestionar reservas, clientes, equipo,
              servicios y reservas online desde un solo panel. Menos tiempo
              improvisando y más tiempo atendiendo bien a tus clientes.
            </p>
